...
Namespace testdbDataSetTableAdapters
    ...
    Partial Public Class StudentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE (((? = 1 AND `SName` IS NULL) OR (`SName` = ?)) AND ("& _ 
                "`SNo` = ?))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Student` (`SName`, `SNo`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Student` SET `SName` = ?, `SNo` = ? WHERE (((? = 1 AND `SName` IS NULL) O"& _ 
                "R (`SName` = ?)) AND (`SNo` = ?))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApplication1.My.MySettings.Default.testdbConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SName, SNo FROM Student"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SName As String, ByVal Original_SNo As Integer) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_SNo,Integer)
        ...
        Public Overloads Overridable Function Insert(ByVal SName As String, ByVal SNo As Integer) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal SName As String, ByVal SNo As Integer, ByVal Original_SName As String, ByVal Original_SNo As Integer) As Integer
            If (SName Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_SNo,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal SName As String, ByVal Original_SName As String, ByVal Original_SNo As Integer) As Integer
            Return Me.Update(SName, Original_SNo, Original_SName, Original_SNo)
        End Function
    End Class
